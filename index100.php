...
<body>	<!--INPUT TYPE="button" onClick="location.reload()" VALUE="RELOAD PAGES"-->
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_folder"><a href="index.php?content=tutup_takop">Tutup Takop</a></li>
			<li class="icn_folder"><a href="index.php?content=blokir_tabum">Blokir/Buka blokir</a></li>
			<li class="icn_folder"><a href="index.php?content=rak">Cek RAK</a></li>
		</ul>
		<h3>Realisasi baru</h3>
		<ul class="toggle">
			<li class="icn_folder"><a href="index.php?content=provisi">Update Provisi</a></li>
			<li class="icn_photo"><a href="index.php?content=hak_tarik">Update Hak tarik</a></li>
		</ul>
		<h3>Pindah-Pindah</h3>
		<ul class="toggle">
		...
		<h3>Pindah AO (kumulatif)</h3>
		<ul class="toggle">
			<li class="icn_folder"><a href="index.php?content=pindah_ao_kumulatif">Pindah AO</a></li>
			<!--li class="icn_folder"><a href="index.php?content=edit_provisi_kumulatif">EDIT PROVISI</a></li-->
		</ul>

		<h3>Autodebet/Pelunasan Dini</h3>
		<ul class="toggle">
			<li class="icn_view_users"><a href="index.php?content=lunas">CEK PELUNASAN</a></li>
			<li class="icn_add_user"><a href="upsert/index">Insert Data</a></li>
			<li class="icn_view_users"><a href="index.php?content=process">Proses Pelunasan</a></li>
		</ul>
			<h3>Mobile</h3>
		<ul class="toggle">
<li class="fa fa-hand-peace-o" style="font-size:20px;"><a href="index.php?content=lunasdini"><font size = '2'>Anggota Lunas Dini/Meninggal</font></a></li>
<li class="fa fa-hand-peace-o" style="font-size:20px;"><a href="index.php?content=laporan"><font size = '2'>Update No.Bukti</font></a></li>
<li class="fa fa-hand-peace-o" style="font-size:20px;"><a href="index.php?content=mobile"><font size = '2'>Cek Kasir</font></a></li>
		...
		<ul class="toggle">
			...
			<li class="icn_settings"><a href="index.php?content=apkc">Error Approve</a></li>
		...
		<footer>
			<hr />
			<p><strong>&copy; 2016 MIS team</strong></p>
