        ...
        <script>
			$().ready(function(){
                $('#prov').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_update_ka1.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
...
<header><h3 class="tabs_involved">Update Nomor KA</h3></header>
<div class="row">
...
<div class="col-lg-12">
                    <div class="bs-example">
                        <form id="prov" method="post">
							<input class="col-lg-8"  name="no_ka" placeholder="Contoh Format KA : 024.00.M.4354.04.2016" required></input>
