...
<script>
			$().ready(function(){
                $('#Input2').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/helpdesk_update_nominal.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
...
<div class="module_content">    
 ...
 <?php
		$query = pg_query("select g_000001 as ktr , s_000000 as uraian,l_000043 as no_ka , l_000039 as nominal, l_000000 as namrek from m_02_006 
