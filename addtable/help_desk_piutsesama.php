...
<div></div>
    <div class="module_content">    
			...
			<?php
			$query = pg_query("		SELECT m_01_002.g_000001 as cbg, 
									SUM(f_000004) as nominatif, 
									l_000032 as neraca, 
									l_000032 - SUM(f_000004)  as cek  
									FROM m_01_002, m_02_001 
									WHERE l_000026 = '1000251'   
									and m_01_002.p_000002 = '18' and m_01_002.g_000001 = m_02_001.g_000001 
									GROUP BY m_01_002.g_000001,l_000032 
									ORDER BY m_01_002.g_000001");
