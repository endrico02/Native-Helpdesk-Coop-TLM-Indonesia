...
<script>
			$().ready(function(){
                $('#Input20').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datacifupdate.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
...
<div></div>
    <div class="module_content">    
			...
			$query = pg_query("		SELECT 	namacabang,norek,nama,tgl_tagih,nama_staff,kd_kel,nama_kelompok 
									...
									where 	 tagihan_kelompok_tbl.ktr = m_00_001.g_000001 and m_00_001.g_000001 in ('024','031','035','036','038','039','040','041','042','043','044')  and tagihan_kelompok_tbl.kd_kel is null 
...
<p style="text-align:center;"><font size="2">1.  Data Pindah CIF To Kelompok </font></p>
<p style="text-align:center;"><font size="2">2.  Pindah CIF To Kelompok Dilakukan Jika Kode Kel dan Nama Kel Di Kartu Tagihan NULL</font></p>
</html>