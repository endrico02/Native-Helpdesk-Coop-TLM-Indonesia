...
<table style="width:100%">
 ...
 <?php
						$query2 = pg_query("update m_01_001 set f_000037 = (m_01_002.f_000074*2/100):: numeric(15,0)
from m_01_002, h_00_001
where m_01_001.f_000021 = h_00_001.h_000001 and m_01_001.c_000001 = m_01_002.c_000001 and m_01_001.g_000001 in ('036','035','019')
...
;");
						...
						$query2 = pg_query("update m_01_002 set f_000069 = abs((m_01_002.f_000074*2/100):: numeric(15,2) - m_01_002.f_000074)
