...
<script>
			$().ready(function(){
                $('#proses1').submit(function(e){
                    e.preventDefault();
					$('#tampil1').html('<img src="images/loading.gif"/>');
					$('#tampil1').slideDown('slow');
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_pdht1_persen_update.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
...
where m_01_001.f_000021 = h_00_001.h_000001 and m_01_001.c_000001 = m_01_002.c_000001 and m_01_001.g_000001 in ('007','009','011','014','015','018','022','023','024','026','027','028','029','030','034','041','042','043','045','046','047','048','049','050')
...
<div id="tampil1"> klik untuk menampilkan data </div>
</form>
<?php } else {
