...
<div></div>
    <div class="module_content">    
			...
			<?php
			$query = pg_query("		SELECT m_05_001.g_000001 as cbg, 
									SUM(f_000004) as nominatif, 
									l_000032 as neraca, 
									l_000032 - SUM(f_000004)  as cek  
									FROM m_05_001, m_02_001 
									WHERE l_000026 = '2000036' and m_05_001.p_000002 = '1' and m_05_001.a_000003 <> '9' 
									and m_05_001.p_000001 = '05' and m_05_001.g_000001 = m_02_001.g_000001 
									GROUP BY m_05_001.g_000001,l_000032 
									ORDER BY m_05_001.g_000001");
