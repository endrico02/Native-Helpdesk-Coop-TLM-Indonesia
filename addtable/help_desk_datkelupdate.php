...
<body>
 ...
 $sql =     pg_query("	UPDATE 
 									tagihan_kelompok_tbl set kd_kel = m_00_001.a_000060, 
 									nama_kelompok = m_00_002.a_000061
						from 		m_00_001, m_00_002
						where 		tagihan_kelompok_tbl.ktr = m_00_001.g_000001 and m_00_001.g_000001 in 
									('024','031','035','036','038','039','040','041','042','043','044')  
									and tagihan_kelompok_tbl.kd_kel <> m_00_002.a_000060 
