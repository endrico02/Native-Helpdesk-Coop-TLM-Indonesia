...
<table style="width:100%">
 ...
 <?php
$query1 = pg_query("update m_01_001 set f_000037 = (m_01_002.f_000074*0.5/100):: numeric(15,0)
...
$query2 = pg_query("update m_01_002 set f_000069 = abs((m_01_002.f_000074*0.5/100):: numeric(15,2) - m_01_002.f_000074)
...
$no = 1;
					...
					} $num_rows = pg_affected_rows($query);
					 echo "$num_rows Rows\n";
