...
<div></div>
    <div class="module_content">    
			...
			<?php
			$query = pg_query("SELECT g_000001 as ktr, g_000039 as sts, t_000013 as cif, a_000057 as nama, s_000000 as ket, g_000036 as waktu, t_000008 as jlh, t_000002 as no_bukti from t_01_003
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			$.ajax({
				url: "addtable/proses_nobukti_angsuran.php?id="+x+"&data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'dana_blokir'){
					$(z).html(y);}
