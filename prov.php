        ...
        <script>
			$().ready(function(){
                $('#Input').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_pdht2.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
				...
				$('#provht25').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_pdht25.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
...
<div class="col-lg-12">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                            <li><a href="#pdht25" data-toggle="tab">ProvHT 2.5%</a></li>
                            <li><a href="#pdht2" data-toggle="tab">ProvHT 2%</a></li>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="pdht2">
							ProvHT 2%
                                <p><form id="Input">
										<input class="btn btn-default btn-sm btn-xs" type="submit" value='Panggil Data'/>
										<button type="reset" onClick="location.reload()">Reset</button>
							...
							<div class="tab-pane fade" id="pdht1">
							ProvHT SERTAmu
							<p><form id="Input2">
										<input class="btn btn-default btn-sm btn-xs" type="submit" value='Panggil Data'/>
										<button type="reset" onClick="location.reload()">Reset</button>
