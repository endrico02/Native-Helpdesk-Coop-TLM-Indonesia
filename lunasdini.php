        ...
        <script>
			$().ready(function(){
                $('#prov').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_lunasdini.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
...
<header><h3 class="tabs_involved">Anggota Lunas Dini/Meninggal</h3></header>
<div class="row">
...
<div class="col-lg-12">
				...
				<p style="text-align:center;"><strong><font size="6" color = 'green'>Perhatikan Cif dan Nama Sebelum Proses!</font></strong></p>	
