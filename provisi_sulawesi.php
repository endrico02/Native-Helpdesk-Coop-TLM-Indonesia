        ...
        <script>
			$().ready(function(){
				...
				$('#Input1_palu').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_pdht1_palu.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
				...
				$('#Input2_palu').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_pdht2_palu.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
...
<header><h3 class="tabs_involved">Provisi Dan Hak Tarik Area Sulawesi</h3></header>
<div class="row">
...
<div class="col-lg-12">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                            <li><a href="#pdht2_palu" data-toggle="tab">ProvHT 2%</a></li>
                            <li><a href="#pdht1_palu" data-toggle="tab">ProvHT 1%</a></li>
                        </ul>
...
<p style="text-align:center;"><font size="2">1.  Pilih Tab "ProvHT 2%" (Untuk Provisi dan Hak Tarik 2%) Dan Tab "ProvHT 1%" (Untuk Provisi dan Hak Tarik 1%) </font></p>
