        ...
        <script>
			$().ready(function(){
                $('#Input').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datpokok.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
				...
				$('#Input2').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datjenis.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
				...
				$('#Input3').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datstsreal.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
				...
				$('#Input4').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datststakop.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
                ...
                $('#Input5').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datnobuk.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
                 ...
                 $('#Input6').submit(function(e){
                    e.preventDefault();
					$('#content6').html('<img src="images/loading.gif"/>');
					$('#content6').slideDown('slow');
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/help_desk_datnobuk.php',
                        'data': $(this).serialize(),
...
<div class="col-lg-12">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                            <li><a href="#stsreal" data-toggle="tab">Status Realisasi Agg</a></li>
                            
                            <li ><a  href="#jenis" data-toggle="tab">Jenis Agg</a></li>
							<li ><a  href="#ststakop" data-toggle="tab">Status Agg Koperasi</a></li>
							<!--<li ><a  href="#nobuk" data-toggle="tab">Reversal (Angsuran)</a></li>
							<li ><a  href="#noagg" data-toggle="tab">Reversal (Asuransi,Titipan,Pembulatan)</a></li>-->
                        </ul>
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade active in" id="stsreal">
							Status Realisasi Nasabah
						...
						<input class="col-lg-8" name="cif" placeholder="Masukan CIF" required></input>
							...
							<div class="tab-pane fade" id="ststakop" method="post">
						...
						<input class="col-lg-8" name="cif" placeholder="Masukan CIF" required></input>
								...
								<input class="btn btn-default btn-sm btn-xs" type="submit" value='pilih'/>
                         		...
                         		<div class="tab-pane fade" id="nobuk">
							Reversal Angsuran
                                <p><form id="Input5">
									<input class="btn btn-default btn-sm btn-xs" type="submit" value='panggil'/>
									<button type="reset" onClick="location.reload()">Reset</button>
                            ...
                            <div class="tab-pane fade" id="noagg">
							Reversal Asuransi, Titipan, Pembulatan
                                <p><form id="Input6">
									<input class="btn btn-default btn-sm btn-xs" type="submit" value='panggil'/>
									<button type="reset" onClick="location.reload()">Reset</button>
									</form>
									<div id="content6"></div></p>
                            </div>
                        </div>
                    </div>
                </div>
