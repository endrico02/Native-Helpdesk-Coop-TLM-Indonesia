...
<script type="text/javascript" src="js/jquery-1.7.2.min.js"></script>
        <script>
			$().ready(function(){
                $('#asuransi').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/helpdesk_keterangan_asuransi.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
    ...
    //             });
				...
				$('#angsuran').submit(function(e){
                    ...
                    $.ajax({
                        'type': 'POST',
                        'url': 'addtable/helpdesk_keterangan_angsuran.php',
                        'data': $(this).serialize(),
						'cache': false,
						'async': true,
                        'success': function(html){
...
<header><h3 class="tabs_involved">Edit Keterangan (Angusuran dan Asuransi)</h3></header>
<div class="row">
...
<div class="col-lg-12">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                            <li><a href="#agsrn" data-toggle="tab"><b>Angsuran</b> (does not pass validation test)</a></li>
                            <li><a href="#asrsi" data-toggle="tab"><b>Asuransi</b> (value too long)</a></li>
